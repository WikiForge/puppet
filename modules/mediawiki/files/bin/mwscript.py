...
def get_commands(args: argparse.Namespace) -> CommandInfo | int:
    ...
    if wiki == 'all':
        ...
        long = True
        generate = f'php {runner}/srv/mediawiki/{args.version}/extensions/WikiForgeMagic/maintenance/generateExtensionDatabaseList.php --wiki=hubwiki --extension={args.extension} --directory=/home/{os.getlogin()}'
