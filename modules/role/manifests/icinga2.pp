...
#
class role::icinga2 (
    String $icinga2_db_host                 = lookup('icinga_ido_db_host', {'default_value' => 'db21.inside.wf'}),
    ...
    String $icingaweb2_db_host              = lookup('icingaweb_db_host', {'default_value' => 'db21.inside.wf'}),
    ...
    String $icingaweb2_ido_db_host          = lookup('icinga_ido_db_host', {'default_value' => 'db21.inside.wf'}),
