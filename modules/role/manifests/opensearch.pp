...
class role::opensearch (
    ...
    class { 'opensearch':
        config      => {
            ...
            'plugins.security.ssl.http.pemkey_filepath'             => '/etc/ssl/private/inside.wf.key',
            'plugins.security.ssl.http.pemcert_filepath'            => '/etc/ssl/localcerts/inside.wf.crt',
            'plugins.security.ssl.http.pemtrustedcas_filepath'      => '/etc/ssl/certs/ISRG_Root_X1.pem',
            'plugins.security.ssl.transport.pemkey_filepath'        => '/etc/ssl/private/inside.wf.key',
            'plugins.security.ssl.transport.pemcert_filepath'       => '/etc/ssl/localcerts/inside.wf.crt',
